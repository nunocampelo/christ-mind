...
`entity-resolution.md` (increment #6).
...
| 6 | Entity resolution: merge surface forms into entities, with the LLM choosing among candidates rather than inventing them | next: `entity-resolution.md` |
